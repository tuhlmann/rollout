...
echo "Installing on Ubuntu Budgie 20.04 for user $THE_USER"
...
add_packages "build-essential apt-transport-https ca-certificates curl \
     software-properties-common git-core git git-lfs gnome-tweaks \
     dconf-editor ffmpeg \
     vim vim-gui-common vim-gtk htop python-pycurl language-pack-de \
     ack-grep exuberant-ctags ruby rake gnupg-agent gnome-sushi"
